...
<header>
  <section class="c-half-layout p-header js-fit-content">
    <div class="c-half-layout__item p-header__item js-fit-content__container">
      ...
      <div class="p-header__button-another js-fit-content__item">
        <button class="p-header__button-another-body js-hover js-scroll-to-btn" data-target="1"><span>本講座に関するお問い合わせ｜↓</span></button>
      </div><?php endif; ?>
