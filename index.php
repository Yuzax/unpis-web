...
</style><link rel="preconnect" href="https://fonts.googleapis.com"/><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="crossorigin"/><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Kosugi+Maru&amp;family=Quicksand:wght@500;600;700&amp;display=block"/><link rel="preload" as="style" href="<?php bloginfo("template_directory"); ?>/assets/css/style.css?v=<?php echo date("YmdHis"); ?>"/><?php wp_head(); ?></head><body data-barba="wrapper" data-section="0"><div class="l-wrap" data-barba="container" data-barba-namespace="common"><?php if ( !is_single() ) : ?>
...
<?php include get_template_directory() . '/parts/dancing-man.php'; ?></div></div><?php if ( !is_single() ) : ?>
<?php get_footer(); ?>
