...
<footer data-section="1">
  <div class="c-half-layout js-fit-content js-fit-content--only-pc">
    <div class="c-half-layout__item c-half-layout__item--vertical">
      <div class="c-vertical-half"><?php $news_group = get_field('news_letter', 'option'); ?>
        <div class="c-vertical-half__item p-news-letter js-fit-content__container">
          <?php
        ...
        <div class="c-vertical-half__item p-contact-group js-fit-content__container">
          ...
          if($related_links):
          ?>
          <h5 class="p-contact-group__link-title js-fit-content__item">関連リンク</h5>
          <ol class="p-contact-group__link-list js-fit-content__item">
            <?php
    ...
    <div class="c-half-layout__item c-half-layout__item--only-pc"><?php $img_array = get_image_array('footer_image', 'option'); ?>
