    ...
    <div class="l-container">
      <article class="c-works-slider">
        ...
        <div class="c-works-slider-item js-works-slider__item <?php if($index != 0) echo 'is-hide'; ?>">
          <div class="c-works-slider-item__image <?php if(get_sub_field('description')){ echo 'c-works-slider-item__image--with-description'; } ?>"><img alt="<?= get_the_title() . ' image'; ?>" width="<?= $image_array['width']; ?>" height="<?= $image_array['height']; ?>" src="<?= $image_array['small']; ?>" srcset="<?= $image_array['small'] . ' 375w, ' . $image_array['thumbnail'] . ' 750w, ' . $image_array['medium'] . ' 1500w, ' . $image_array['large'] . ' 3000w'; ?>" sizes="100vw"/></div><?php if(get_sub_field('description')): ?>
        ...
        <div class="c-works-information-modal js-works-information-modal js-works-slider__information-modal js-change-color-target">
          <article class="c-works-information-modal__container js-works-information-modal__container">
            ...
            <ul class="c-works-information-modal__link-list"><?php while(have_rows('links')): the_row(); ?>
              <li class="p-works-link"><a class="p-works-link__body js-change-color-target js-hover" href="<?= get_sub_field('url'); ?>" target="_blank" rel="noopener noreferrer" aria-label="リンクを別タブで開く">
                  <?php
