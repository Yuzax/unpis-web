...
<body data-barba="wrapper" data-section="0">
  <div class="l-wrap" data-barba="container" data-barba-namespace="common">
    ...
    <div class="l-container">
      ...
      ?>
      <div class="c-about">
        <div class="c-about__arrow js-change-color-target <?php if($is_dark_mode){ echo ' is-rev'; }; ?>">
        ...
        <hr class="c-about__border js-change-color-target <?php if($is_dark_mode){ echo ' is-rev'; }; ?>">
