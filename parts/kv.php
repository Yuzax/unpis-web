...
?><img class="<?= $add_class; ?>" alt="KV Image" width="<?= $image_array['width']; ?>" height="<?= $image_array['height']; ?>" src="<?= $image_array['small']; ?>" srcset="<?= $image_array['small'] . ' 375w, ' . $image_array['thumbnail'] . ' 750w, ' . $image_array['medium'] . ' 1500w, ' . $image_array['large'] . ' 3000w, ' . $image_array['ex_large'] . ' 4000w' ; ?>" sizes="150vw" loading="lazy" decoding="async" fetchpriority="high"/><?php $index = $index + 1; endforeach; endif; ?></div><div class="c-kv__image-wrap c-kv__image-wrap--sp js-kv__image-wrap"><?php
$index = 0;
if($sp_images): foreach($sp_images as $sp_image):
  $image_array = get_image_array($sp_image['image']);
  $add_class = $index != 0? 'is-hide' : '';
?><img class="<?= $add_class; ?>" alt="KV Image" width="<?= $image_array['width']; ?>" height="<?= $image_array['height']; ?>" src="<?= $image_array['small']; ?>" srcset="<?= $image_array['small'] . ' 375w, ' . $image_array['thumbnail'] . ' 750w, ' . $image_array['medium'] . ' 1500w'; ?>" sizes="100vw" loading="lazy" decoding="async" fetchpriority="high"/><?php $index = $index + 1; endforeach; endif; ?></div></div><?php endif; ?>
<?php
if($gesture == 'parallax'):
...
?><div class="c-kv__image-wrap c-kv__image-wrap--parallax js-kv__image-wrap" data-parallax-strength="<?= $slide_image['parallax_strength']; ?>"><?php $image_array = get_image_array($slide_image['image_group']['pc_image']); ?><img alt="KV Image" width="<?= $image_array['width']; ?>" height="<?= $image_array['height']; ?>" src="<?= $image_array['small']; ?>" srcset="<?= $image_array['small'] . ' 375w, ' . $image_array['thumbnail'] . ' 750w, ' . $image_array['medium'] . ' 1500w, ' . $image_array['large'] . ' 3000w, ' . $image_array['ex_large'] . ' 4000w' ; ?>" sizes="150vw" loading="lazy" decoding="async" fetchpriority="high"/><?php $image_array = get_image_array($slide_image['image_group']['sp_image']); ?><img alt="KV Image" width="<?= $image_array['width']; ?>" height="<?= $image_array['height']; ?>" src="<?= $image_array['small']; ?>" srcset="<?= $image_array['small'] . ' 375w, ' . $image_array['thumbnail'] . ' 750w, ' . $image_array['medium'] . ' 1500w'; ?>" sizes="100vw" loading="lazy" decoding="async" fetchpriority="high"/></div><?php endforeach; endif; ?></div><?php endif; ?></div><?php endif; ?>