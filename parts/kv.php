  ...
  <div class="c-kv__container js-kv <?php if($gesture == 'click'){ echo 'js-kv--click'; }else{ echo 'js-kv--hold'; } ?>">
    ...
    <div class="c-kv__image-wrap c-kv__image-wrap--sp js-kv__image-wrap">
      ...
      if($sp_images): foreach($sp_images as $sp_image):
        ...
        $add_class = $index != 0? 'is-hide' : '';
      ?><img class="<?= $add_class; ?>" alt="KV Image" width="<?= $image_array['width']; ?>" height="<?= $image_array['height']; ?>" src="<?= $image_array['small']; ?>" srcset="<?= $image_array['small'] . ' 375w, ' . $image_array['thumbnail'] . ' 750w, ' . $image_array['medium'] . ' 1500w'; ?>" sizes="100vw" loading="lazy" decoding="async" fetchpriority="high"/><?php $index = $index + 1; endforeach; endif; ?>
    </div>
  </div><?php endif; ?>
  <?php
  if($gesture == 'parallax'):
